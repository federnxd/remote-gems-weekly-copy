...
export const PLATFORMS = [
  ...
  },
  {
    ...
    label: 'Facebook',
    group: 'social',
    tone: 'Friendly, community-focused, conversational. Use emojis, keep it engaging and shareable.',
    color: '#1877f2',
    bgActive: 'bg-[#1877f2]',
  ...
  },
  {
    ...
    label: 'Mastodon',
    group: 'social',
    tone: 'Open, community-driven, no-algorithm feed. Authentic and conversational. Use hashtags for discoverability. Max 500 chars.',
    color: '#6364ff',
    bgActive: 'bg-[#6364ff]',
    borderActive: 'border-[#6364ff]',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-3.5 h-3.5">
  ...
  // --- Job Boards (copy-paste targets) ---
  {
    ...
    label: 'Indie Hackers',
    group: 'jobboard',
    tone: 'Founder-friendly, builder community. Emphasize mission, equity, growth potential, and bootstrapped culture.',
    color: '#0e2150',
    bgActive: 'bg-[#0e2150]',
    borderActive: 'border-[#0e2150]',
    icon: <span className="text-[10px] font-bold">IH</span>,
  },
  {
    id: 'facebook',
    label: 'Facebook',
  ...
  // --- Job Boards (copy-paste targets) ---
  {
    ...
    label: 'Indie Hackers',
    group: 'jobboard',
    tone: 'Founder-friendly, builder community. Emphasize mission, equity, growth potential, and bootstrapped culture. Be real and transparent.',
    color: '#0e2150',
    bgActive: 'bg-[#0e2150]',
    borderActive: 'border-[#0e2150]',
    icon: <span className="text-[10px] font-bold">IH</span>,
